...
the published GitHub prerelease, public rendered catalogue/version-selector/package
...
Tagged release workflow `36100097156` completed `SUCCESS` for the exact
candidate. Authenticated staging acceptance and npm publication remain pending
sign-in, and production promotion remains pending. GitHub publication is
complete. Fix-forward is preferred; legacy readiness does not prove a full
rollback, and no live rollback was executed.
