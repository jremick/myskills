...
- Keep the open-source product clean-room by default. Public files should not copy private code, private content, identity assumptions, deployment URLs, or organization-specific terminology.
