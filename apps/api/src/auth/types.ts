...
export const apiTokenScopes = ["profile:read", "skills:read", "architectures:read", "skills:submit", "review:read", "review:write", "targets:execute", "libraries:read", "libraries:write"] as const;
