...
test("organization visibility is gated and not treated as authenticated in the memory skill repository", async () => {
...
test("new organization-visible submissions require the instance gate and metadata cannot change visibility", async () => {
  ...
  await assert.rejects(
    ...
    (error) => error instanceof AppError &&
      error.code === "ORGANIZATION_SHARING_DISABLED" &&
